...
const quadrant4Data = [
  {
    ...
    mobileFov: 100,
    color: "#172226",
    mobileCameraPosition: [1.1, .2, 1.3],
    mobileOrbitTarget: [0.9, 0.05, 1.04],
  ...
  },
  {
    ...
    fov: 50,
    mobileFov: 70,
    mobileCameraPosition: [1.3, .2, 1.19],
    mobileOrbitTarget: [1.05, 0.05, 1.05],
  ...
  },
  {
    ...
    fov: 30,
    mobileOrbitTarget: [0.35, 0.07, 1.0],
    mobileCameraPosition: [.5, .5, 0],
    mobileFov: 50,
    color: '#4682B4',
    color: '#4682B4',
  ...
  },
  {
    ...
    mobileOrbitTarget: [0.9, 0.05, 1.3],
    mobileFov: 25,
    color: '#BC4A3C',
  ...
  },
  {
    ...
    fov: 7,
    mobileCameraPosition: [-1.2, .5, 1.65],
    mobileOrbitTarget: [0.4, 0.09, 1.3],
    mobileFov: 30,
    color: '#725438',
  ...
  },
  {
    ...
    fov: 15,
    mobileCameraPosition: [1.2, 0.25, 1.5],
    mobileOrbitTarget: [1.6, 0.03, 1.1],
    mobileFov: 45,
  ...
  },
  {
    ...
    fov: 20,
    mobileOrbitTarget: [0.85, 0.05, 1.52],
    mobileCameraPosition: [.5, .2, 1.7],
    mobileFov: 40,
    color: '#AD0407',
    secondaryColor: '2B601E',
