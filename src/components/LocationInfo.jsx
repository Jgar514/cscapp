...
const LocationInfo = ({
  ...
  setSelectedLocation,
  resetAppState,
  handleMoreInfoClick, // Pass the function as a prop
  handleLessInfoClick  // Add the function to reset camera settings
}) => {
  ...
  const handleToggleDetail = () => {
    ...
    if (!isDetailExpanded && selectedLocation) {
      // Expand detail and apply camera settings
      handleMoreInfoClick();
    } else if (isDetailExpanded && selectedLocation) {
      // Collapse detail and reset camera settings
      handleLessInfoClick();
    }
  };
